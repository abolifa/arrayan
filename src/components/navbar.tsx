      ...
      <header className="container mx-auto px-5 xl:px-0 flex items-center justify-between transition-colors duration-300">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="flex items-center justify-center w-9 h-9 rounded-full border transition border-black/20 text-black hover:bg-green-500"
          >
          ...
          <button
            onClick={() => setOpen((v) => !v)}
            className="md:hidden p-2 rounded-md transition hover:bg-black/5 text-black"
            aria-label="Menu"
          >
